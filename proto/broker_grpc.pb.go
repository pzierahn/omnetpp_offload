...
type StargateClient interface {
	Relay(ctx context.Context, in *RelayRequest, opts ...grpc.CallOption) (*Port, error)
}
...
func (c *stargateClient) Relay(ctx context.Context, in *RelayRequest, opts ...grpc.CallOption) (*Port, error) {
	out := new(Port)
	err := c.cc.Invoke(ctx, "/service.Stargate/Relay", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StargateServer interface {
	Relay(context.Context, *RelayRequest) (*Port, error)
...
func (UnimplementedStargateServer) Relay(context.Context, *RelayRequest) (*Port, error) {
...
func _Stargate_Relay_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RelayRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StargateServer).Relay(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/service.Stargate/Relay",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StargateServer).Relay(ctx, req.(*RelayRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Stargate_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "service.Stargate",
	HandlerType: (*StargateServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Relay",
			Handler:    _Stargate_Relay_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "broker.proto",
