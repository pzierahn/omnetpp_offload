...
type ProviderClient interface {
	...
	StartEvaluation(ctx context.Context, in *EvaluationScenario, opts ...grpc.CallOption) (*emptypb.Empty, error)
	StopEvaluation(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *providerClient) StartEvaluation(ctx context.Context, in *EvaluationScenario, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/service.Provider/StartEvaluation", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *providerClient) StopEvaluation(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/service.Provider/StopEvaluation", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ProviderServer interface {
	...
	StartEvaluation(context.Context, *EvaluationScenario) (*emptypb.Empty, error)
	StopEvaluation(context.Context, *emptypb.Empty) (*emptypb.Empty, error)
...
func (UnimplementedProviderServer) StartEvaluation(context.Context, *EvaluationScenario) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method StartEvaluation not implemented")
}
func (UnimplementedProviderServer) StopEvaluation(context.Context, *emptypb.Empty) (*emptypb.Empty, error) {
...
func _Provider_StartEvaluation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EvaluationScenario)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProviderServer).StartEvaluation(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/service.Provider/StartEvaluation",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProviderServer).StartEvaluation(ctx, req.(*EvaluationScenario))
	}
	return interceptor(ctx, in, info, handler)
}

func _Provider_StopEvaluation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProviderServer).StopEvaluation(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/service.Provider/StopEvaluation",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProviderServer).StopEvaluation(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Provider_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Provider_StartEvaluation_Handler,
		},
		{
			MethodName: "StopEvaluation",
			Handler:    _Provider_StopEvaluation_Handler,
		},
	},
